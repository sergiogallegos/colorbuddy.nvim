-- CustomBuddy Cursor IDE Variant
-- Inspired by Cursor IDE's modern, clean color scheme
-- Features: Clean, modern colors with excellent contrast and professional appearance

require("colorbuddy").colorscheme("custombuddy-cursor")
...
-- Base editor group with Cursor IDE styling
Group.new("Normal", c.superwhite, c.transparent)

-- Cursor IDE status line
Group.new("StatusLine", c.superwhite, c.transparent) -- Clean status line
Group.new("StatusLineNC", c.silver_text, c.transparent, s.none) -- Subtle inactive
Group.new("StatusLineTerm", c.superwhite, c.transparent) -- Terminal status line
Group.new("StatusLineTermNC", c.silver_text, c.transparent, s.none) -- Inactive terminal

-- Cursor IDE line numbers and cursor
...
-- Cursor IDE signs and diagnostics
...
-- Cursor IDE syntax with clean styling
...
Group.new("@comment", c.seagreen, nil, s.italic) -- Comments in blue-gray with italic
...
-- Notes
-- =====================
-- 1. Cursor IDE inspired variant with clean, modern colors
-- 2. Professional appearance with excellent contrast
-- 3. Blue accent theme for consistency
-- 4. Clean, minimal styling throughout
-- 5. Perfect for modern development workflows
